...
module.exports.get['/'] = function(req, res){
  ...
  db_real.inquiries.findStacks(function (err, stacks) {
    if (err) {
      res.end(); //@TODO: write an error page!
    }
    else {
      res.render('index', {
        title: 'study.js',
...
module.exports.get['/stack/:name'] = function(req, res) {
  var data = { stack: req.params.name };

  //
  //attempt to do this with real data:
  //
  db_real.inquiries.getStack(db_real.mongoose, data, function (err, cards) {
    console.log(util.inspect(cards, false, null)); //@TODO: remove me!!    
