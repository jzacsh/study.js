...
console.log(util.inspect(db_real.mongoose.modelSchemas.Stack.methods, false, 6)); //@TODO: remove me!!    
console.log('util.inspect(db_real.mongoose, false, 6)'); //@TODO: remove me!!    
console.log(util.inspect(db_real.mongoose, false, 6)); //@TODO: remove me!!    
// console.log(util.inspect(db_real.path(?
// console.log(util.inspect(db_real.pre(?
