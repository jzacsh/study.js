...
module.exports.post['/stack/new'] = function(req, res) {
  res.render('stack', {
...
module.exports.post['/export/xml'] = function(req, res) {
  res.send('FPO: export/xml response here');
};

module.exports.post['/export/json'] = function(req, res) {
  res.send('FPO: export/JSON response here');
};

module.exports.post['/stack/:name'] = function(req, res) {
...
module.exports.post['/stack/:name/export/xml'] = function(req, res) {
  res.send('FPO: /stack/:name/export/xml response here');
};

module.exports.post['/stack/:name/export/json'] = function(req, res) {
  res.send('FPO: /stack/:name/export/JSON response here');
};

module.exports.post['/stack/:name/card/new'] = function(req, res) {
...
module.exports.post['/stack/:name/card/:id'] = function(req, res) {
