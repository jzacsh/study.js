...
var util = require('util'); //@TODO: remove me!!    
  //@TODO: use mongodb-native driver, this is way too much work.
  console.log('about to run `find()`...'); //@TODO: remove me!!    
  var ret = db_real.Stack.find({}, { _id: true }, function(err, docs) {
    console.log('going through document results...'); //@TODO: remove me!!    
    console.log('error (possibly) passed:'); //@TODO: remove me!!    
    console.log(util.inspect(err, false, null)); //@TODO: remove me!!    
    docs.forEach(function (stack_slug) {
      console.log('found stack:'); //@TODO: remove me!!    
      console.log(util.inspect(stack_slug, false, null)); //@TODO: remove me!!    
    });
  });
  console.log('ret from db.find() was:'); //@TODO: remove me!!    
  console.log(util.inspect(ret, false, null)); //@TODO: remove me!!    
  console.log('... moved passed `find()`'); //@TODO: remove me!!    
