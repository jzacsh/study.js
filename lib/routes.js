...
module.exports.get['/'] = function(req, res){
  ...
  db_real.inquiries.listStacks(db_real.mongoose, function (err, stacks) {

    console.log('printing expected stacks structure'); //@TODO: remove me!!    
    console.log(util.inspect(db.stacks, false, null)); //@TODO: remove me!!    
    console.log('printing real stacks'); //@TODO: remove me!!    
    console.log(util.inspect(stacks, false, null)); //@TODO: remove me!!    
